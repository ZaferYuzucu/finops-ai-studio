  ...
  const TimelineItem: React.FC<{ icon: React.ReactNode; title: string; phase: string; children: React.ReactNode; align?: 'left' | 'right' }> = ({ icon, title, phase, children, align = 'left' }) => (
    <div className={`relative flex items-center ${align === 'left' ? 'justify-start' : 'justify-end'}`}>
      <div className={`w-1/2 ${align === 'left' ? 'pr-8' : 'pl-8'} ${align === 'left' ? 'text-right' : 'text-left'}`}>
        <div className="bg-white border border-gray-200 p-6 rounded-2xl shadow-xl transform hover:scale-105 transition-transform duration-300">
        ...
        <div className="relative">
          ...
          <div className="space-y-16">
            ...
            <TimelineItem icon={<Bot size={28} />} title="Platform Yönetimi, Dashboard Governance & Telif Koruma (v5)" phase="Safha 25" align="left">
                ...
                <p className="mt-3 font-semibold text-purple-300">Bu güncellemeler, “demo gösterilebilirlik” ile “kurumsal güven ve yönetilebilirlik” dengesini koruyacak şekilde tasarlandı.</p>
                <p className="mt-2 text-right text-sm text-slate-500">— GPT-5.2 (Cursor), AI Coding Agent</p>
                <p className="text-right text-xs text-slate-600">10 Ocak 2026</p>
            </TimelineItem>
